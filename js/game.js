...
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    window.onload = function() {
      var game = new Phaser.Game(320, 512, Phaser.AUTO, 'gameArea');
  ...
  }, { "./states/boot": 9, "./states/gameover": 10, "./states/menu": 11, "./states/play": 12, "./states/preload": 13 }],
  2: [function(require, module, exports) {
    ...
    var getFrame = function(block, left, top, right, bottom) {
      ...
      if (sum !== 2) {
        ...
        if (type === 11) { frameNum = 2;
          block.angle = 90; } else if (type === 110) { frameNum = 2; } else if (type === 101) { frameNum = 5; } else if (type === 1100) { frameNum = 2;
          block.angle = 270; } else if (type === 1010) { frameNum = 5;
          block.angle = 90; } else { frameNum = 2;
          block.angle = 180; }
      }
  ...
  3: [function(require, module, exports) {
    ...
    Bunny.prototype.update = function() {
      ...
      if ((mid.pitch < -15 || this.cursors.left.isDown || (this.game.input.pointer1.isDown && this.game.input.pointer1.screenX < this.game.width / 2)) && this.controllable) {
        this.body.velocity.x = this.powertimer > 0 ? -POWER_TURN : -NORMAL_TURN;
      }

      if ((mid.pitch > 15 || this.cursors.right.isDown || (this.game.input.pointer1.isDown && this.game.input.pointer1.screenX >= this.game.width / 2)) && this.controllable) {
        this.body.velocity.x = this.powertimer > 0 ? POWER_TURN : NORMAL_TURN;
      }
      ...
      if (this.powertimer > 0) {
        ...
        this.boosting = false;
      } else if (mid.intensity - lastIntensity > 10) {
        boostCounter = 30;
  ...
  11: [function(require, module, exports) {
    ...
    Menu.prototype = {
      create: function() {
        ...
        // else { str_sub = 'DRILL\nBUNNY'; str_prs = 'Jump To Start!';}

        // This breaks localization :(

        // if (isMobile) {
        //  str_prs = "Jump To Start!";
        // }
        ...
        this.title = this.game.add.text(4, 4, 'credit:\nChacket Valleyparker', { fill: 'red' });
        this.title.font = "Press Start 2P";
        this.title.fontSize = 12;
        this.title.align = 'left';
        this.title2 = this.game.add.text(4, 46, 'adapt: Eric Chiu', { fill: 'red' });
        this.title2.font = "Press Start 2P";
        this.title2.fontSize = 12;
        this.title2.align = 'left';

        this.sub = this.game.add.text(4, 72, str_sub + "\n ");
        ...
        this.gsConnect = this.game.add.text(4, this.game.height / 2, "GaussSense\nNot Detected");
        this.gsConnect.font = "Press Start 2P";
        this.gsConnect.fontSize = 24;
        this.gsConnect.align = 'center';
        this.gsConnect.x = (this.game.width - this.gsConnect.width) / 2;
        this.gsConnect.visible = false;

        this.press = this.game.add.text(0, this.game.height - 32, str_prs);
        this.press.font = "Press Start 2P";
        this.press.fontSize = 20;
        ...
        this.game.add.tween(this.title2).to({ y: this.title2.y + 16 }, 2000, Phaser.Easing.Quadratic.InOut, true, 0, Number.MAX_VALUE, true);
      ...
      update: function() {
        ...
        var mid = gs.getBipolarMidpoint();
        if (((mid.intensity - lastIntensity > 10) || this.start.isDown || this.game.input.pointer1.isDown) && !this.starting) {
  ...
  12: [function(require, module, exports) {
      ...
      update: function() {
        if (!this.dead) {
          ...
          if (this.bunny.health < 0) {
            ...
            this.depthyo = this.game.add.text(32, 300, 'DEPTH ' + this.depthtext.text, { fill: 'white' });
            this.depthyo.font = "Press Start 2P";
            this.depthyo.fontSize = 16;
            this.depthyo.fixedToCamera = true;

            this.cashyo = this.game.add.text(32, 320, 'CASH ' + this.cashtext.text, { fill: 'white' });
            this.cashyo.font = "Press Start 2P";
            this.cashyo.fontSize = 16;
            this.cashyo.fixedToCamera = true;

            this.pressspace = this.game.add.text(8, 400, 'JUMP TO RETRY\n\nTHANKS FOR PLAYING!', { fill: 'white' });
          ...
          var mid = gs.getBipolarMidpoint();
          if (mid.intensity - lastIntensity > 10) {
            this.dfx.volume = 0;
    ...
    module.exports = Play;
  }, { "../prefabs/Block.js": 2, "../prefabs/Bunny.js": 3, "../prefabs/Carrot.js": 4, "../prefabs/Gauge.js": 5, "../prefabs/Gem.js": 6, "../prefabs/Lava.js": 7, "../prefabs/Rock.js": 8 }],
